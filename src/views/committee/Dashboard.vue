...
<template>
  <div class="space-y-8">
    <!-- Welcome Section -->
    <div class="bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-2xl p-8 text-white shadow-xl">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold mb-2">Committee Dashboard</h1>
          <p class="text-indigo-100 text-lg">Manage your sinking fund operations and monitor financial activities</p>
        </div>
